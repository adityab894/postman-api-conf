...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <div className="fixed top-0 left-0 w-full h-20 bg-white z-[999]">
      <div
  className="absolute top-0 right-0 h-screen z-0 bg-cover"
  style={{ 
    width: "25%", 
    height: "1200%",
    backgroundImage: "url('/3.png')", 
    backgroundPosition: "inherit" // or "inherit"
  }}
/>
...
<section className="relative flex flex-col md:flex-row items-center px-10 py-16 overflow-hidden mt-20 ml-40">
  {/* Content container */}
  <div className="relative z-10 flex flex-col md:flex-row items-center w-full">
    <div className="flex-1 space-y-6 text-center md:text-left">
      <h1 className="text-5xl font-extrabold leading-tight text-gray-900">
      ...
      <p className="text-gray-600 max-w-lg">
        The API Conf Pune 2025 is the first edition of a community-driven
        flagship conference, hosted by the Postman Community Pune. Marking the
        beginning of a new chapter in India&apos;s tech ecosystem, this
        conference is dedicated to changing the API revolution in India by
        bringing together developers, architects, product leaders, and
        technology enthusiasts from across the country. Designed to spark
      ...
      <section className="px-10 py-16 bg-white">
  <div className="max-w-6xl ml-70 mr-20">
    <div className="bg-white rounded-2xl shadow-lg p-12">
      <div className="grid md:grid-cols-2 gap-12">
        {/* Left Section */}
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            At KoiAmor, we believe that true well-being begins with remembering
            who you are — beneath the noise, the roles, and the expectations.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <p className="text-gray-700 text-lg leading-relaxed">
            We were born not out of a business plan, but a lived experience: the
            ache of burnout, the silence around mental health, the disconnection
            from the body, and the longing for something deeper.
          </p>
          <p className="text-lg font-semibold text-gray-700 italic">
            KoiAmor is a return — to your rhythm, your truth, and your
            wholeness.
          </p>
          <p className="text-gray-700 text-lg leading-relaxed">
            We&apos;re here to create experiences that don&apos;t just inform,{" "}
            <span className="font-bold">but transform</span>.
          </p>
        </div>
      </div>
    </div>
